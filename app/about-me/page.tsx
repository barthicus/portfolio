...
export const metadata = {
  ...
  description: "I'm a Polish Front-End Developer building and maintaining web applications using React and TypeScript."
}
        ...
        <div className="col-span-12 space-y-5">
          <div>
            <p className="text-zinc-500 dark:text-zinc-400">
              As a Polish Front-End Developer working in cooperation with Voltiso, a Polish startup, I build and
          ...
          <div className="mt-10 flex gap-3">
            ...
            <div>
              ...
              <p className="mt-4 text-zinc-500 dark:text-zinc-400">
                I started my journey with web development in 2009 by designing and building simple landing pages with{' '}
                ...
                I even created few websites in <strong className="text-zinc-600 dark:text-zinc-300">Flash</strong> (AS3)
                which is considered as a history relic now.
              </p>
              <p className="mt-4 text-zinc-500 dark:text-zinc-400">
                Then I continueed to develop my skills by reating custom web layouts, building more complex websites
                like <strong className="text-zinc-600 dark:text-zinc-300">CRMs</strong> in{' '}
                <strong className="text-zinc-600 dark:text-zinc-300">PHP</strong>. I created few projects with 3D
                interactions using <strong className="text-zinc-600 dark:text-zinc-300">ThreeJS</strong> and{' '}
                <strong className="text-zinc-600 dark:text-zinc-300">Vue.js</strong> (steel constructions creators).
              </p>
              <p className="mt-4 text-zinc-500 dark:text-zinc-400">
                From the beggining, I went through many different technologies (PHP, Action Script) and frameworks/libs
                (jQuery, Gatsby, Vue.js), but most of the time I was interested the most in the{' '}
          ...
          <div className="mt-10 flex gap-3">
            ...
            <div>
              ...
              <p className="mt-4 text-zinc-500 dark:text-zinc-400">
                Family is everything to me so I spend most of my free time with my two kids and my lovely wife ❤️
                Outside of that, I really enjoy cooking, running and calisthenics.
              </p>
              <p className="mt-4 text-zinc-500 dark:text-zinc-400">
