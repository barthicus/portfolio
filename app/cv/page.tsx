        ...
        <div className="grid-cols-12 items-center pt-4 md:gap-10 md:pt-[30px] lg:grid ">
          <div className="col-span-12 flex flex-col space-y-2.5">
            <p className="text-zinc-500 dark:text-zinc-400">
              This is my resume with some projects I&apos;ve worked on. You can also download it as a{' '}
              <Link
                href="/cv-pdf"
                target="_blank"
            ...
            <p className="mt-4 text-zinc-500 dark:text-zinc-400">
              Featured projects are hidden by default but you can show them by clicking on the &quot;Reveal
              projects&quot; button below.
            </p>
