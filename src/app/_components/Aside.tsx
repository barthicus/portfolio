...
export const Aside = () => {
  return (
    <aside className={clsx("relative mx-auto mb-6 mt-[180px] w-full md:mt-[220px] lg:my-0")}>
      <Image
        alt="Bartosz Podgruszecki avatar"
        src={avatarImg}
        priority
        className="absolute left-[50%] z-10 mx-auto mt-[-140px] h-[240px] w-[240px] translate-x-[-50%] rounded-[20px] drop-shadow-xl"
      />
      <div
        className={clsx(
          "relative mx-auto mb-6 mt-[180px] w-full overflow-hidden rounded-[20px] bg-white px-6 text-center dark:bg-[#111111] md:mt-[220px] lg:my-0",
