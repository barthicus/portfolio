...
const SocialIconLink = ({ href, children }: { href: string; children: ReactNode }) => {
  return (
    <a href={href} target="_blank" rel="noopener noreferrer">
      <span className="flex h-10 w-10 items-center justify-center rounded-md bg-gray-100 text-gray-500 transition-colors duration-300 ease-out hover:bg-gradient-to-l hover:from-red-600 hover:via-red-600 hover:to-pink-500 hover:text-white">
        {children}
      </span>
    </a>
  )
...
export const Aside = () => {
  return (
    <aside className="relative mx-auto mb-6 mt-[180px] w-full rounded-[20px] bg-white px-6 text-center dark:bg-[#111111] md:mt-[220px] lg:my-0">
      <Image
        alt="Bartosz Podgruszecki avatar"
        src={avatarImg}
        priority
        className="absolute left-[50%] mx-auto mt-[-140px] h-[240px] w-[240px] translate-x-[-50%] rounded-[20px] drop-shadow-xl"
      />
