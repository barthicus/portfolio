...
export const MenuLink = ({
  ...
  return (
    <Link
      ...
      onClick={onClick}
      className={clsx(
        "flex cursor-pointer flex-col items-center justify-center bg-[#F3F6F6] py-6 font-mono text-sm font-medium transition-all duration-300 ease-in-out lg:mx-2.5 lg:h-20 lg:w-20 lg:rounded-[10px] lg:py-0",
