          ...
          <div className="col-span-12 space-y-5">
            ...
            <div className="mt-10 flex gap-3">
              ...
              <div>
                ...
                <p className="mt-4 text-zinc-500 dark:text-zinc-400">
                  ...
                  <strong className="text-zinc-600 dark:text-zinc-300">Figma</strong> for designing
                  and prototyping.
                </p>
            ...
            <div className="mt-10 flex gap-3">
              ...
              <div>
                ...
                <p className="mt-4 text-zinc-500 dark:text-zinc-400">
                  I started my journey with web development in 2009 by designing and building simple
                  landing pages with{" "}
                  <strong className="text-zinc-600 dark:text-zinc-300">WordPress</strong> and basic
                  scripts like product price calculators in JavaScript -{" "}
                  <strong className="text-zinc-600 dark:text-zinc-300">jQuery</strong>. I even
                  created few websites in{" "}
                  <strong className="text-zinc-600 dark:text-zinc-300">Flash</strong> (AS3) which is
                  considered as a history relic now 🦕
                </p>
                <p className="mt-4 text-zinc-500 dark:text-zinc-400">
            ...
            <div className="mt-10 flex gap-3">
              ...
              <div>
                ...
                <p className="mt-4 text-zinc-500 dark:text-zinc-400">
                  Family is everything to me so I spend most of my free time with my two kids and my
                  lovely wife ❤️ Outside of that, I really enjoy cooking, running and calisthenics.
                </p>
                <p className="mt-4 text-zinc-500 dark:text-zinc-400">
