          ...
          <div className="col-span-12 space-y-2.5">
            <div className="lg:mr-16">
              <p className="text-gray-500 dark:text-gray-100">
                I&apos;m Polish Front-End Developer who is not afraid of learning new things. I
                really enjoy building modern web applications using React (Next.js) and Typescript.
              </p>
            </div>
            <WipInfo />
          </div>
